...
rank_result_path = "./evaluation/dataset/rankings"
embedding_result_path = "./evaluation/dataset/embeddings"
...
def prefix_append(text_list, text_type):
    if text_type== "query":
        return ["query: " + text for text in text_list]
    elif text_type == "passage":
        ret=[]
        for pool in text_list:
            ret.append(["passage: "+ text for text in pool])
