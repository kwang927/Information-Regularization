...
from preparation_consistency_filtering import get_consistency_filtered_data
from preparation_large_batch import get_pair_data, get_pair_data_arguana
sys.path.append("./training")
from train_large_batch import training_model_large_batch
...
def main(query_type="gator4", num_experiment = 10, name = "vanilla1", query_num = 4000, cuda = "0,1,2,3,4,5,6,7", margin =0.05, batch_size = 80, half= True, shuffle = False, model_name = "e5", max_breach = 5):
    ...
    for i in range(num_experiment):
        ...
        print("==============================Start Initial training process==============================")

        training_model_large_batch(batch_size, num_epochs, experiment_name, cuda, margin, shuffle, half, model_name, max_breach)
        
        print("==============================Start Consistency Filtering process==============================")
                
        get_consistency_filtered_data(experiment_name, model_name, cuda)
        
        print("==============================Start training after consistency filtering ==============================")
        ...
        if 'arguana' in experiment_name:
            ...
            curr_check_point_path = f"{name}_{i}_model_{model_name}_1"
            ...
            print("succssfully removed current model checkpoint")
...
if __name__ == "__main__":
    ...
    main(query_type = query_type, num_experiment = num_experiment, name = name, query_num = query_num, cuda = cuda, margin= margin, batch_size=batch_size, half= half, shuffle = shuffle, model_name = model_name)
